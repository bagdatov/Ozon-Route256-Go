...
import (
	...
	"gitlab.ozon.dev/bagdatov/homework-3/service-monitoring-order/internal/controller/http"
	"gitlab.ozon.dev/bagdatov/homework-3/service-monitoring-order/internal/controller/kafka"
	"gitlab.ozon.dev/bagdatov/homework-3/service-monitoring-order/internal/repository"
	"gitlab.ozon.dev/bagdatov/homework-3/service-monitoring-order/internal/usecase"
	"gitlab.ozon.dev/bagdatov/homework-3/service-monitoring-order/migrations"
	"log"
)
...
func Run(conf *config.Config) {
	...
	broker, err := repository.NewSyncProducer(conf.Brokers, conf.ResetTopic)
	if err != nil {
